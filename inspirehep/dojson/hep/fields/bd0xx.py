...
def isbns(self, key, value):
    def _get_medium(value):
        def _normalize(medium):
            ...
            valid_mediums = schema['properties']['isbns']['items']['properties']['medium']['enum']
...
def texkeys(self, key, value):
    ...
    def _is_other_texkey(other_id, schema):
        return other_id and schema in ('INSPIRETeX', 'SPIRESTeX')
    ...
    for value in values:
        ...
        elif _is_other_texkey(other_id, schema):
